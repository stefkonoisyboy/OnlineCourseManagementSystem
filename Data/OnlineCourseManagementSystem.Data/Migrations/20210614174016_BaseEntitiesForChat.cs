namespace OnlineCourseManagementSystem.Data.Migrations
{
    ...
    public partial class BaseEntitiesForChat : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MessageEmojis", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MessageEmojis_AspNetUsers_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MessageEmojis_Emojis_EmojiId",
                        column: x => x.EmojiId,
                        principalTable: "Emojis",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MessageEmojis_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageEmojis_CreatorId",
                table: "MessageEmojis",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageEmojis_EmojiId",
                table: "MessageEmojis",
                column: "EmojiId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageEmojis_MessageId",
                table: "MessageEmojis",
                column: "MessageId");
